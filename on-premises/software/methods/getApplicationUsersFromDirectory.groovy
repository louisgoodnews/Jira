...
private LinkedHashMap<String, Serializable> getApplicationUsersFromDirectory(String directoryName){
    ...
    LinkedList<ApplicationUser> applicationUserList = userSearchService.findUsers(serviceContext, "") as LinkedList<ApplicationUser>;
