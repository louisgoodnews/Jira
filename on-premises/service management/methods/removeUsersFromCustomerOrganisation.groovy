...
private void removeUsersFromCustomerOrganisation (String organisationName, String projectKey, List<ApplicationUser> usersToRemove) {
    ...
    UsersOrganizationUpdateParameters usersOrganizationUpdateParameters = organizationService.newUsersOrganizationUpdateParametersBuilder().organization(customerOrganizations.getResults().find{ CustomerOrganization it -> it.name == organisationName}).users(usersToRemove as Set<ApplicationUser>).build();
